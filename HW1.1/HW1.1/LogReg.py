...
class LogReg:
    ...
    def get_coef(self):
        self.a = (sum((self.raw_data['x']-np.mean(self.raw_data['x']))*(self.raw_data['y']-np.mean(self.raw_data['y']))))/sum((self.raw_data['x']-np.mean(self.raw_data['x'])))
        self.b = np.mean(self.raw_data['y']) - np.mean(self.raw_data['x'])*self.a
